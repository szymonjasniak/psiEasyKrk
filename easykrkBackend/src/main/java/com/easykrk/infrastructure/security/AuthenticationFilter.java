...
public class AuthenticationFilter extends GenericFilterBean {
    ...
    private final  String auth="/rest/auth";
    ...
    private boolean postToAuthenticate(HttpServletRequest httpRequest, String resourcePath) {
        return auth.equalsIgnoreCase(resourcePath) && httpRequest.getMethod().equals(RequestMethod.POST.name());
    }
    ...
    private void processUsernamePasswordAuthentication(HttpServletResponse httpResponse, Optional<String> username, Optional<String> password) throws IOException {
        ...
        TokenResponse tokenResponse = new TokenResponse(resultOfAuthentication.getDetails().toString(),TokenService.CACHE_VALID);
